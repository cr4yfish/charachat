...
const PureCharacterEdit = ({ character } : { character: Character }) => {
    ...
    return (
        <div className="size-full flex flex-col-reverse lg:flex-row gap-4 px-4 overflow-y-auto max-h-screen pt-[75px] pb-24">
            ...
            <div className="flex flex-col gap-4">
                ...
                {/* Danger zone */}
                <AlertDialog>
                    <div className="flex flex-col gap-1 p-3 rounded-2xl !bg-transparent border-2 border-yellow-400 border-dashed">
